...
namespace System.Buffers
{
	...
	{
		// Token: 0x060007FE RID: 2046 RVA: 0x00030417 File Offset: 0x0002E617
		internal DefaultArrayPool() : this(1048576, 50)
		{
		}

		// Token: 0x060007FF RID: 2047 RVA: 0x00030428 File Offset: 0x0002E628
		...
		// (get) Token: 0x06000800 RID: 2048 RVA: 0x000304AF File Offset: 0x0002E6AF
		private int Id
		{
			get
			{
		...
		// Token: 0x06000801 RID: 2049 RVA: 0x000304B8 File Offset: 0x0002E6B8
		...
		// Token: 0x06000802 RID: 2050 RVA: 0x000305C0 File Offset: 0x0002E7C0
		...
		{
			// Token: 0x06000803 RID: 2051 RVA: 0x00030632 File Offset: 0x0002E832
			...
			// (get) Token: 0x06000804 RID: 2052 RVA: 0x000304AF File Offset: 0x0002E6AF
			internal int Id
			{
				get
				{
			...
			// Token: 0x06000805 RID: 2053 RVA: 0x00030664 File Offset: 0x0002E864
			internal T[] Rent()
			{
			...
			// Token: 0x06000806 RID: 2054 RVA: 0x00030720 File Offset: 0x0002E920
			internal void Return(T[] array)
			{
				if (array.Length != this._bufferLength)
				{
					throw new ArgumentException(SR.get_ArgumentException_BufferNotFromPool(), "array");
				}
				bool flag = false;
				try
				{
