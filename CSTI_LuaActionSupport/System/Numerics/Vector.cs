...
namespace System.Numerics
{
	...
	internal struct Vector<T> : IEquatable<Vector<T>>, IFormattable where T : struct
	{
		...
		// (get) Token: 0x060006B3 RID: 1715 RVA: 0x0001B076 File Offset: 0x00019276
		...
		// (get) Token: 0x060006B4 RID: 1716 RVA: 0x0001B07D File Offset: 0x0001927D
		...
		// (get) Token: 0x060006B5 RID: 1717 RVA: 0x0001B084 File Offset: 0x00019284
		...
		// (get) Token: 0x060006B6 RID: 1718 RVA: 0x0001B08B File Offset: 0x0001928B
		...
		// Token: 0x060006B7 RID: 1719 RVA: 0x0001B094 File Offset: 0x00019294
		private unsafe static int InitializeCount()
		{
			...
			else
			{
				...
				{
					throw new NotSupportedException(SR.get_Arg_TypeNotSupported());
				}
				num2 = 8;
			}
			return num / num2;
		...
		// Token: 0x060006B8 RID: 1720 RVA: 0x0001B22C File Offset: 0x0001942C
		[Intrinsic]
		...
		// Token: 0x060006B9 RID: 1721 RVA: 0x0001BC8E File Offset: 0x00019E8E
		[Intrinsic]
		...
		// Token: 0x060006BA RID: 1722 RVA: 0x0001BC98 File Offset: 0x00019E98
		public unsafe Vector(T[] values, int index)
		{
			this = default(Vector<T>);
			if (values == null)
			{
				throw new NullReferenceException(SR.get_Arg_NullArgumentNullRef());
			}
			if (index < 0 || values.Length - index < Vector<T>.Count)
			{
				SR.get_Arg_InsufficientNumberOfElements();
				throw new IndexOutOfRangeException(SR.Format(Vector<T>.Count, "values"));
			}
			if (Vector.IsHardwareAccelerated)
			{
				if (typeof(T) == typeof(byte))
		...
		// Token: 0x060006BB RID: 1723 RVA: 0x0001C91A File Offset: 0x0001AB1A
		internal unsafe Vector(void* dataPointer)
		{
			this = new Vector<T>(dataPointer, 0);
		}

		// Token: 0x060006BC RID: 1724 RVA: 0x0001C924 File Offset: 0x0001AB24
		...
		// Token: 0x060006BD RID: 1725 RVA: 0x0001CD09 File Offset: 0x0001AF09
		private Vector(ref Register existingRegister)
		{
			this.register = existingRegister;
		}

		// Token: 0x060006BE RID: 1726 RVA: 0x0001CD17 File Offset: 0x0001AF17
		[Intrinsic]
		...
		// Token: 0x060006BF RID: 1727 RVA: 0x0001CD24 File Offset: 0x0001AF24
		[Intrinsic]
		public unsafe void CopyTo(T[] destination, int startIndex)
		{
			...
			{
				throw new ArgumentOutOfRangeException("startIndex", SR.Format(SR.get_Arg_ArgumentOutOfRangeException(), startIndex));
			}
			if (destination.Length - startIndex < Vector<T>.Count)
			{
				throw new ArgumentException(SR.Format(SR.get_Arg_ElementsInSourceIsGreaterThanDestination(), startIndex));
			}
			if (Vector.IsHardwareAccelerated)
			{
				if (typeof(T) == typeof(byte))
		...
		public unsafe T this[int index]
		{
			...
			get
			{
				...
				{
					throw new IndexOutOfRangeException(SR.Format(SR.get_Arg_ArgumentOutOfRangeException(), index));
				}
				if (typeof(T) == typeof(byte))
				{
					fixed (byte* ptr = &this.register.byte_0)
		...
		// Token: 0x060006C1 RID: 1729 RVA: 0x0001DC83 File Offset: 0x0001BE83
		...
		// Token: 0x060006C2 RID: 1730 RVA: 0x0001DC9C File Offset: 0x0001BE9C
		[Intrinsic]
		...
		// Token: 0x060006C3 RID: 1731 RVA: 0x0001E494 File Offset: 0x0001C694
		...
		// Token: 0x060006C4 RID: 1732 RVA: 0x0001EF11 File Offset: 0x0001D111
		public override string ToString()
		{
			return this.ToString("G", CultureInfo.CurrentCulture);
		}

		// Token: 0x060006C5 RID: 1733 RVA: 0x0001EF23 File Offset: 0x0001D123
		public string ToString(string format)
		{
			return this.ToString(format, CultureInfo.CurrentCulture);
		}

		// Token: 0x060006C6 RID: 1734 RVA: 0x0001EF34 File Offset: 0x0001D134
		...
		// Token: 0x060006C7 RID: 1735 RVA: 0x0001EFD4 File Offset: 0x0001D1D4
		...
		// Token: 0x060006C8 RID: 1736 RVA: 0x0001FEB0 File Offset: 0x0001E0B0
		public unsafe static Vector<T>operator -(Vector<T> left, Vector<T> right)
		{
			if (!Vector.IsHardwareAccelerated)
			{
		...
		// Token: 0x060006C9 RID: 1737 RVA: 0x00020D8C File Offset: 0x0001EF8C
		public unsafe static Vector<T>operator *(Vector<T> left, Vector<T> right)
		{
			if (!Vector.IsHardwareAccelerated)
			{
		...
		// Token: 0x060006CA RID: 1738 RVA: 0x00021C68 File Offset: 0x0001FE68
		...
		// Token: 0x060006CB RID: 1739 RVA: 0x0002271C File Offset: 0x0002091C
		...
		// Token: 0x060006CC RID: 1740 RVA: 0x000231D0 File Offset: 0x000213D0
		public unsafe static Vector<T>operator /(Vector<T> left, Vector<T> right)
		{
			if (!Vector.IsHardwareAccelerated)
			{
		...
		// Token: 0x060006CD RID: 1741 RVA: 0x000240A9 File Offset: 0x000222A9
		public static Vector<T>operator -(Vector<T> value)
		{
			return Vector<T>.Zero - value;
		}

		// Token: 0x060006CE RID: 1742 RVA: 0x000240B8 File Offset: 0x000222B8
		[Intrinsic]
		public unsafe static Vector<T>operator &(Vector<T> left, Vector<T> right)
		{
			Vector<T> result = default(Vector<T>);
		...
		// Token: 0x060006CF RID: 1743 RVA: 0x00024174 File Offset: 0x00022374
		[Intrinsic]
		public unsafe static Vector<T>operator |(Vector<T> left, Vector<T> right)
		{
			Vector<T> result = default(Vector<T>);
		...
		// Token: 0x060006D0 RID: 1744 RVA: 0x00024230 File Offset: 0x00022430
		[Intrinsic]
		public unsafe static Vector<T>operator ^(Vector<T> left, Vector<T> right)
		{
			Vector<T> result = default(Vector<T>);
		...
		// Token: 0x060006D1 RID: 1745 RVA: 0x000242EC File Offset: 0x000224EC
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Vector<T>operator ~(Vector<T> value)
		{
		...
		// Token: 0x060006D2 RID: 1746 RVA: 0x000242F9 File Offset: 0x000224F9
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006D3 RID: 1747 RVA: 0x00024303 File Offset: 0x00022503
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool operator !=(Vector<T> left, Vector<T> right)
		{
			return !(left == right);
		...
		// Token: 0x060006D4 RID: 1748 RVA: 0x0002430F File Offset: 0x0002250F
		[Intrinsic]
		...
		// Token: 0x060006D5 RID: 1749 RVA: 0x0002431D File Offset: 0x0002251D
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060006D6 RID: 1750 RVA: 0x0002432B File Offset: 0x0002252B
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060006D7 RID: 1751 RVA: 0x00024339 File Offset: 0x00022539
		[Intrinsic]
		...
		// Token: 0x060006D8 RID: 1752 RVA: 0x00024347 File Offset: 0x00022547
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060006D9 RID: 1753 RVA: 0x00024355 File Offset: 0x00022555
		[Intrinsic]
		...
		// Token: 0x060006DA RID: 1754 RVA: 0x00024363 File Offset: 0x00022563
		[CLSCompliant(false)]
		[Intrinsic]
		...
		// Token: 0x060006DB RID: 1755 RVA: 0x00024371 File Offset: 0x00022571
		[Intrinsic]
		...
		// Token: 0x060006DC RID: 1756 RVA: 0x0002437F File Offset: 0x0002257F
		[Intrinsic]
		...
		// Token: 0x060006DD RID: 1757 RVA: 0x0002438D File Offset: 0x0002258D
		[Intrinsic]
		...
		// Token: 0x060006DE RID: 1758 RVA: 0x0002439C File Offset: 0x0002259C
		[Intrinsic]
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006DF RID: 1759 RVA: 0x000253A8 File Offset: 0x000235A8
		[Intrinsic]
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006E0 RID: 1760 RVA: 0x000263B4 File Offset: 0x000245B4
		[Intrinsic]
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006E1 RID: 1761 RVA: 0x000273BF File Offset: 0x000255BF
		[Intrinsic]
		...
		// Token: 0x060006E2 RID: 1762 RVA: 0x000273D4 File Offset: 0x000255D4
		[Intrinsic]
		...
		// Token: 0x060006E3 RID: 1763 RVA: 0x000273E9 File Offset: 0x000255E9
		[Intrinsic]
		...
		// Token: 0x060006E4 RID: 1764 RVA: 0x00027400 File Offset: 0x00025600
		[Intrinsic]
		...
		// Token: 0x060006E5 RID: 1765 RVA: 0x00027BC8 File Offset: 0x00025DC8
		[Intrinsic]
		...
		// Token: 0x060006E6 RID: 1766 RVA: 0x00029218 File Offset: 0x00027418
		[Intrinsic]
		...
		// Token: 0x060006E7 RID: 1767 RVA: 0x0002A868 File Offset: 0x00028A68
		[Intrinsic]
		...
		// Token: 0x060006E8 RID: 1768 RVA: 0x0002B1E8 File Offset: 0x000293E8
		[Intrinsic]
		...
		// Token: 0x060006E9 RID: 1769 RVA: 0x0002BEE4 File Offset: 0x0002A0E4
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006EA RID: 1770 RVA: 0x0002C104 File Offset: 0x0002A304
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006EB RID: 1771 RVA: 0x0002C324 File Offset: 0x0002A524
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006EC RID: 1772 RVA: 0x0002C544 File Offset: 0x0002A744
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006ED RID: 1773 RVA: 0x0002C7C4 File Offset: 0x0002A9C4
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006EE RID: 1774 RVA: 0x0002CA44 File Offset: 0x0002AC44
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006EF RID: 1775 RVA: 0x0002CCC4 File Offset: 0x0002AEC4
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006F0 RID: 1776 RVA: 0x0002CF44 File Offset: 0x0002B144
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		// Token: 0x060006F1 RID: 1777 RVA: 0x0002D110 File Offset: 0x0002B310
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
